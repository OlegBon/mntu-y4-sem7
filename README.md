...
| ------------------------------------------------------- | --------------------- | ----------- | ------------------------- |
| Інтелектуальний аналіз даних                            | Python                | ✅ виконано | `IntelligentDataAnalysis` |
| Технології розподілених систем та паралельних обчислень | C#, C++               | ✅ виконано | `DistSysTech`             |
| Методи та засоби аналізу багатовимірних даних           | Python                | ✅ виконано | `MultiData`               |
| Веб орієнтована розробка програмного забезпечення       | HTML, CSS, JavaScript | ✅ виконано | `WebDev`                  |
