...
| Практична робота №4 (PR4)             | ✅ завершено | Побудова нечітких систем, порівняння алгоритмів Мамдані та Сугено     |
...
- `src/pr4-mamdani-sugeno/pr4-task0-comparison.py` — повна реалізація лабораторної роботи з побудовою графіків та генерацією звіту
