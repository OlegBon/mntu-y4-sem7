...
**Дата:** 2025-11-19 21:31

**Мета:** Спроєктувати та реалізувати складні аналітичні зрізи даних для оцінки економічних показників, використовуючи Python.

## 1. Стратегічний зріз: Динаміка Виручки
Аналіз суми продажів у розрізі років та типів каменів.

![Графік виручки](p6_slice_revenue.png)
...
## 3. Продуктовий зріз: Цінова Матриця (Natural)
Теплова карта середньої ціни за карат для природних діамантів.

![Теплова карта](p6_slice_product_matrix.png)
