...
### 3.1. Візуалізація (Товщина ребер = Сила зв'язку)

![Візуалізація графа](12_expert_clarity_graph.png)

### 3.2. Бульбашкова візуалізація (Розмір вузла = Загальна активність)

На цьому графіку розмір кола пропорційний загальній кількості оцінок, зроблених експертом (або отриманих категорією чистоти).

![Бульбашкова візуалізація](12_expert_clarity_graph_bubble.png)
