...
Як видно з графіка, лінійна модель лише частково описує зв'язок. Дані мають чітко виражений **нелінійний (експоненціальний)** характер: ціна зростає набагато швидше, ніж вага. Ця модель є **базовою (baseline)** і буде використана для порівняння з більш складними нелінійними.
